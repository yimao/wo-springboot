...
/**
 * {@link Config} retrieves configuration values from properties file and specifies
 * default values when no value is specified.
 */
public class Config {
     ...
     * Defaults to Constants.KAPTCHA_SESSION_KEY.
     */

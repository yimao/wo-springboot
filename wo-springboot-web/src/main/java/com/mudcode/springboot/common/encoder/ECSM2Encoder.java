...
public class ECSM2Encoder {
    ...
    private static final String ALGORITHM_SIGN = "SM3withSM2";

    static {
        java.security.Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
    }

    private ECSM2Encoder() {
    }
    ...
    public static byte[] encrypt(byte[] data, final PublicKey publicKey) {
        try {
            Cipher cipher = Cipher.getInstance(ALGORITHM_SM2, ALGORITHM_PROVIDER);
